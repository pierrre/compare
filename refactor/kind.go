...
func (vc *KindValuesComparator) CompareValues(st *State, v1, v2 reflect.Value) (yieldOK bool, handled bool) {
	return vc.ValuesComparator[v1.Kind()].CompareValues(st, v1, v2)
}

func (vc *KindValuesComparator) compareInt(st *State, v1, v2 reflect.Value) (yieldOK bool, handled bool) {
	return vc.BaseInt.CompareValues(st, v1, v2)
}

func (vc *KindValuesComparator) compareUint(st *State, v1, v2 reflect.Value) (yieldOK bool, handled bool) {
	return vc.BaseUint.CompareValues(st, v1, v2)
}

func (vc *KindValuesComparator) compareFloat(st *State, v1, v2 reflect.Value) (yieldOK bool, handled bool) {
