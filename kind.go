...
//
// It should be created with [NewKindComparator].
...
func (kvc *KindComparator) Supports(typ reflect.Type) ValuesComparator {
	return supportsValuesComparator(typ, kvc.ValuesComparators[typ.Kind()])
}
