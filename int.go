...
//
// It should be created with [NewIntComparator].
...
func (vc *IntComparator) CompareValues(st *State, v1, v2 reflect.Value) (res Result, handled bool) {
	...
	return Res("int not equal", i1, i2), true
}

// Supports implements [SupportChecker].
func (vc *IntComparator) Supports(typ reflect.Type) ValuesComparator {
	var res ValuesComparator
	switch typ.Kind() { //nolint:exhaustive // Only supports int.
	case reflect.Int, reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64:
		res = vc
	}
	return res
